...
function showCProject(){
    toggleCProjectsDisplay();
    showHelloCProject();
}

function showCPlusPlusProject(){
    toggleCPlusPlusProjectsDisplay();
    showHelloCPlusPlusProject();
}

function showCSharpProject(){
    toggleCSharpProjectsDisplay();
    showHelloCSharpProject();
}

function showArduinoProject(){
    toggleArduinoProjectsDisplay();
    showVaultDoorProject();
}
...
function showHelloCProject(){
    document.getElementById("languageDirectoryURL").href = "https://github.com/VlaKarlo/Projects/tree/main/programming/C/HelloC";
    document.getElementById("languageDirectoryURL").innerHTML = "https://github.com/VlaKarlo/Projects/tree/main/programming/C/HelloC";
    document.getElementById("languageCode").innerHTML = 
    `
    <p>
        #include &#60;stdio.h&#62;<br>
...
function showHelloCPlusPlusProject(){
    document.getElementById("languageDirectoryURL").href = "https://github.com/VlaKarlo/Projects/tree/main/programming/C++/HelloC++";
    document.getElementById("languageDirectoryURL").innerHTML = "https://github.com/VlaKarlo/Projects/tree/main/programming/C++/HelloC++";
    document.getElementById("languageCode").innerHTML = 
    `
...
function showHelloCSharpProject(){
    document.getElementById("languageDirectoryURL").href = "https://github.com/VlaKarlo/Projects/tree/main/programming/C#/HelloC#";
    document.getElementById("languageDirectoryURL").innerHTML = "https://github.com/VlaKarlo/Projects/tree/main/programming/C#/HelloC#";
    document.getElementById("languageCode").innerHTML = 
    `
    <p>
        using System;<br>
        class HelloWorld {<br>
            &emsp;static void Main() {<br>
                &emsp;&emsp;Console.WriteLine("Hello World");<br>
            &emsp;}<br>
        }
    </p>
    `
